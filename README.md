...
- Dictionary mode for single words — auto-detects short selections and shows pronunciation, part of speech, senses, and example; manual Translate/Define toggle on the card
